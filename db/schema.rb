...
ActiveRecord::Schema.define(version: 20160209112854) do
  ...
  create_table "energies", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.decimal  "two_electricity", precision: 16, scale: 4
    t.decimal  "photo",           precision: 16, scale: 4
    t.decimal  "two_photo",       precision: 16, scale: 4
    t.decimal  "two_gaz",         precision: 16, scale: 4
    t.decimal  "two_water",       precision: 16, scale: 4
    t.decimal  "three_water",     precision: 16, scale: 4
    t.decimal  "four_water",      precision: 16, scale: 4
  end
