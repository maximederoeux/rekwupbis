...
ActiveRecord::Schema.define(version: 20160419091731) do
  ...
  create_table "prices", force: :cascade do |t|
    ...
    t.decimal  "washing_small", precision: 8, scale: 4
  end
  ...
  create_table "return_details", force: :cascade do |t|
    ...
    t.integer  "missing_top_ctrl"
    t.integer  "tagged_top_ctrl"
    t.integer  "tagged_box_ctrl"
  end
