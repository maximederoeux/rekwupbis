...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { end_time: @attendance.end_time, start_time: @attendance.start_time, user_id: @attendance.user_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { end_time: @attendance.end_time, start_time: @attendance.start_time, user_id: @attendance.user_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
