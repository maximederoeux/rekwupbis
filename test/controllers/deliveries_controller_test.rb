...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post :create, delivery: { delivery_date: @delivery.delivery_date, order_id: @delivery.order_id, return_date: @delivery.return_date }
    end
  ...
  test "should update delivery" do
    patch :update, id: @delivery, delivery: { delivery_date: @delivery.delivery_date, order_id: @delivery.order_id, return_date: @delivery.return_date }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
