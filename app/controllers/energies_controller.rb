class EnergiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @energy.save
        format.html { redirect_to :back, notice: 'Energy was successfully created.' }
  ...
  private
    ...
    def energy_params
      params.require(:energy).permit(:water, :gaz, :electricity, :two_water, :two_gaz, :two_electricity, :three_water, :four_water)
    end
end
