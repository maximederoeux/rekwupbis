class ArticlesController < ApplicationController
  ...
  private
    ...
    def article_params
      params.require(:article).permit(:article_name, :article_content, :article_type, :article_category, :quantity_bigbox, :quantity_smallbox, :quantity_pile, :washing_price, :handwash_price, :tab_price, :deposit_price, :is_washable, :rekwup_cup, :sell_price)
    end
end
